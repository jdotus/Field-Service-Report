...
$pdf->Cell(100, $lineHeight, "__________________________________________", 0, 0);
$pdf->Cell(20, $lineHeight, "Tel No.:");
$pdf->Cell(35, $lineHeight, "_____________________");
$pdf->Ln($lineHeight);
$pdf->Cell(20, $lineHeight, "Address:");
$pdf->Cell(10, $lineHeight, "____________________________________________________________");

$pdf->Ln($lineHeight);
// Align Model No., Serial No., and Meter Reading on the same row
$pdf->Cell(20, $lineHeight, "Model No.:");
$pdf->Cell(35, $lineHeight, "_________________");
$pdf->Cell(35, $lineHeight, "Serial No.:");
$pdf->Cell(35, $lineHeight, "_________________");
$pdf->Cell(35, $lineHeight, "Meter Reading:");
$pdf->Cell(0, $lineHeight, "_________________");
...
$pdf->Cell(0, $lineHeight, "______________________________________________________");
$pdf->Ln(5.7);
$pdf->Cell(0, 5.7, "______________________________________________________");
...
$pdf->Cell(0, $lineHeight, "_______________________________________________________");
...
$pdf->Cell($widthLeft / 2, $lineHeight, str_repeat('_', 15), 0, 0, 'C'); // Centered underline

// Time Out section
$pdf->Cell(10, $lineHeight, "Time Out:", 0, 0, 'L'); // Label on the left
$pdf->Cell(50, $lineHeight, str_repeat('_', 15), 0, 1, 'C'); // Centered underline and move to next line
